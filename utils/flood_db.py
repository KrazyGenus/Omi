...
parcel_seed_data = [
    {
        ...
        "location": {
            ...
            "state": "NY",
            "country": "USA",
            "facility": "JFK International Hub",
        },
        "movement": {
            "previous_facility": "Los Angeles Sorting Center",
            "next_facility": "Newark Distribution Hub",
            "estimated_arrival": datetime.utcnow() + timedelta(days=2),
        },
        "carrier": "FedEx",
        "tracking_url": "https://www.fedex.com/track?PKG001US",
        "metadata": {"weight_kg": 1.8, "priority": "standard"},
    },
    {
        "parcel_id": "PKG002NG",
        "status": "delivered",
        ...
        "movement": {
            ...
            "next_facility": None,
            "estimated_arrival": datetime.utcnow() - timedelta(hours=7),
        },
        "carrier": "DHL",
